// Elwyn AI – minimal, working wiring (health + chat + image)
// Make sure this file is served at /assets/app.js

// ===== CONFIG =====
const WORKER_URL = "https://elwyn.emailpeterokeke.workers.dev"; // your Worker
const DEFAULT_MODEL = "latest"; // Worker maps 'latest' to GPT-5 Thinking if allowed

function currentModel() {
  const sel = document.getElementById("engineSelect");
  return (sel && sel.value) ? sel.value : DEFAULT_MODEL;
}
...
// ===== Sidebar: simple view switcher (if present) =====
(() => {
